    ...
    FocusScope{
        ...
        MouseArea{
            ...
            onClicked: {
                ...
                modeloDocumentosEnLiquidaciones.buscarDocumentosEnLiquidaciones(codigoLiquidacion,codigoVendedor,modeloListaPerfiles.retornaCodigoPerfil(txtNombreDeUsuario.textoInputBox.trim()))
    ...
    BotonCargarDato {
        ...
        onClic: {
            ...
            if(valorCierre=="0"){
                ...
                modeloDocumentosEnLiquidaciones.limpiarListaDocumentos()
                modeloDocumentosEnLiquidaciones.buscarDocumentosEnLiquidaciones("null","null","null")
